                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="row">
                            <div class="form--container padding--lg">
                                <h4 class="font--bold">Create Survey</h4>
                               <form action="saveSurvey" method="post" class="padding--xs" enctype="multipart/form-data">
                                   <label>Add Question :</label> 
                                   <input type="text" name="addQuestion" />
                                   <label>Upload Image:</label>
                                   <input type="file" name="file" />
                                   <label>Question Description : </label>
                                   <textarea rows="5" cols="40" name="sectionDesc"></textarea>
                                  <input type="submit" class="button1 btn--submit" value="Save" />
                               </form>
                            </div>
                        </div>
                    </div>

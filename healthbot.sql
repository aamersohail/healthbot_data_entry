...
-- Script date 5/25/2018 6:08:25 PM
...
--
-- Definition for database healthbot
--
...
--
-- Definition for table tbl_notifications
--
...
-- Table healthbot.tbl_notifications does not contain any data (it is empty)
...
(1, 'Chathu', 'Female', 'Losing Weight', 1, '0405340321', 'Chewaala@deakin.edu.au'),
(2, 'Aamer', 'Male', 'Fitness', 2, NULL, NULL),
(3, 'caro', 'FEMALE', 'JHCDCD', 2, NULL, NULL),
(4, 'nikhi', 'FEMALE', 'CCDC', 2, NULL, NULL),
(5, 'Sandesh', 'MALE', 'SCJIECE', 1, NULL, NULL),
(6, 'chathu', 'female', 'gfgfg', 1, NULL, NULL);
...
(5, 'dsgds', '0017-07-10 00:00:00', '0028-07-10 00:00:00', 6);
